...
import { ProjectManagementCreateProjectComponent } from '../../project-management-create-project/project-management-create-project/project-management-create-project.component'
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ProjectManagementProjectComponent, ProjectManagementCreateProjectComponent, FormsModule],
