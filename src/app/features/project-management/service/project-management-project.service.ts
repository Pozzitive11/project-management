...
export class ProjectManagementProjectService {
  ...
  deleteProject(projectId: number) {
    this.projectManagementHttpService.deleteProject(projectId).subscribe((data) => {
      this.filterProjects(projectId)
    })
  }
  updateProject(projectId: number, projectName: string, projectDescription: string) {
    this.projectManagementHttpService.updateProject(projectId, projectName, projectDescription).subscribe((data) => {
